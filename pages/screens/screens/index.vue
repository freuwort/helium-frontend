<template>
    <NuxtLayout name="auth-default" :scope :pageTitle="IPM.options.pageTitle" color="#84cc16">
        <HeCard>
            ...
            >
                <template #right>
                    <IodButton type="button" label="Neuer Screen" corner="pill" icon-right="add" @click="IPM.open()"/>
                </template>
            </IodTable>
        </HeCard>
    </NuxtLayout>
...
<script lang="ts" setup>
    ...
    const scope = 'view_admin_screen_screens_index'
    ...
    const IPM = useItemPageManager({
        ...
        routes: {
            ...
            delete: '/api/screens',
            editor: '/screens/screens/editor/:id',
        },
    })
    ...
    const tableColumns = [
        ...
        { name: 'background', label: 'Hintergrund', valuePath: 'background', sortable: true, width: 200, resizeable: true, hideable: true, default: '-' },
