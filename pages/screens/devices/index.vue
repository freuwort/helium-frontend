...
<script lang="ts" setup>
    ...
    const IPM = useItemPageManager({
        ...
        routes: {
            ...
            editor: '/screens/devices/editor/:id',
        },
    })
    ...
    const tableColumns = [
        ...
        { name: 'group', label: 'Gruppe', valuePath: 'group', sortable: true, width: 200, resizable: true, hideable: true, default: '-' },
        { name: 'address', label: 'Adresse', valuePath: 'address.full_address_with_country', sortable: false, width: 200, resizable: true, hideable: true, default: '-' },
        { name: 'address_notes', label: 'Notiz', valuePath: 'address.notes', sortable: false, width: 200, resizable: true, hideable: true, default: '-' },
