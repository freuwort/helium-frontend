<template>
    <div class="iod-container iod-otp-input" ref="wrapper" tabindex="0" @focus="onFocus">
        <input
            ref="inputs"
            maxlength="1"
            tabindex="-1"
        ...
        <div class="otp-divider" v-for="divider in dividers" :style="{order: divider-1}"></div>
    </div>
</template>
